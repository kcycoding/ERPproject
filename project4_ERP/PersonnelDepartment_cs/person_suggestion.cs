...
{
    public partial class person_suggestion : UserControl
    {
        public person_suggestion()
        {
            InitializeComponent();
        }
        ...
        private void button7_Click(object sender, EventArgs e) // 추가후 올리기
        {
            dataGridView1.Rows.Add(title, "인사부", date_write.ToString("yyyy-MM-dd"), content, writer, "미처리");
        ...
        private void Save_csv4(string aaa, DataGridView dgview, bool header) // 이어 넣기 그리드뷰의 내용을 신규추가로 텍스트로 옮겨 적는 코드
        ...
        private void textBox2_TextChanged(object sender, EventArgs e) // 작성자
        {
            writer = textBox2.Text;
        }

        private void textBox3_TextChanged(object sender, EventArgs e) //제목
        {
            title = textBox3.Text;
        }

        private void textBox6_TextChanged(object sender, EventArgs e) // 처리상태
        {
            processing_status = textBox6.Text;
        }

        private void textBox5_TextChanged(object sender, EventArgs e) // 내용
        {
        ...
        private void person_suggestion_Load(object sender, EventArgs e)
        {
