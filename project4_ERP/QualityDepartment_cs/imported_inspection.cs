...
{
    public partial class imported_inspection : UserControl
    {
        public imported_inspection()
        {
            InitializeComponent();
        }

        public static string Lot_report = "imported_inspection.txt";
        public static string file_path = @"C:\\ERP4\\QualityDepartment\\" + Lot_report;
        ...
        private void button5_Click(object sender, EventArgs e) // 저장버튼
        {
        ...
        private void imported_inspection_Load(object sender, EventArgs e)
        {
